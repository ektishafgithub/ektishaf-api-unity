...
> [!IMPORTANT]
> If you don't see any text over buttons or UI then **Import TMP Essentials**. You can import through **Windows->TextMeshPro->Import TMP Essential Resources**
> or an easy way would be to select a text in hierarchy to trigger import as shown below.
<img width="1267" alt="ImportTMPEssentials" src="https://github.com/user-attachments/assets/46fc83f8-6500-4ef0-a750-275706cbcdcc"></br>
